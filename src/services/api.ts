...
// API endpoint from the assignment
...
export const userApi = {
  async getUsers(): Promise<User[]> {
    try {
      ...
      // Return mock data as fallback - this way the demo still works if API is down
...
// Mock data generator for fallback - just some realistic sample data
